...
def get_weak_augmentation(img_size: int = 32, padding: int = 4, padding_mode: str = "reflect"):
    ...
    This is the default augmentation strategy, which randomly crops 12.5% of input images.

    Parameters
    ----------
    img_size:
        Desired size of output images, which is used as input to the RandomCrop function.
    padding: int
